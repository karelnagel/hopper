        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        "FK_Sounds_AspNetUsers_ApplicationUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                table => new
                {
                    Id = table.Column<string>(nullable: false),
                    ApplicationUserId = table.Column<string>(nullable: false),
                    SoundId = table.Column<string>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Favorite", x => x.Id);
                    table.ForeignKey(
                        "FK_Favorite_AspNetUsers_ApplicationUserId",
                        x => x.ApplicationUserId,
                        "AspNetUsers",
                        "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        "FK_Favorite_Sounds_SoundId",
                        x => x.SoundId,
                        "Sounds",
                        "Id",
                        onDelete: ReferentialAction.Cascade);

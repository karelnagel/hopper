        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Sounds_AspNetUsers_ApplicationUserId",
            ...
            migrationBuilder.CreateTable(
                name: "ApplicationUserSound",
                columns: table => new
                {
                    LikedSoundsId = table.Column<string>(type: "varchar(36)", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    LikedUsersId = table.Column<string>(type: "varchar(36)", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationUserSound", x => new { x.LikedSoundsId, x.LikedUsersId });
                    table.ForeignKey(
                        name: "FK_ApplicationUserSound_AspNetUsers_LikedUsersId",
                        column: x => x.LikedUsersId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ApplicationUserSound_Sounds_LikedSoundsId",
                        column: x => x.LikedSoundsId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicationUserSound_LikedUsersId",
                table: "ApplicationUserSound",
                column: "LikedUsersId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Sounds_ApplicationUserId",
                table: "Sounds",
